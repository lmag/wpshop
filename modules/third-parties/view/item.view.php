	...
	<div class="table-cell table-full">
		...
		<ul class="reference-actions">
			...
			<?php if ( Settings::g()->dolibarr_is_active() && ! empty( $third_party->data['external_id'] ) ) : ?>
				<li><a href="<?php echo esc_attr( $doli_url ); ?>/societe/card.php?id=<?php echo $third_party->data['external_id']; ?>&action=edit" target="_blank"><?php esc_html_e( 'Edit in Dolibarr', 'wpshop' ); ?></a></li>
			<?php endif; ?>
		</ul>
	</div>
